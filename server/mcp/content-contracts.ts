...
/** Likewise a brew: the authoring tool logs one off the shelf. */
export const draftBrewSchema = brewSchema.extend({
  published: z.boolean(),
})
...
export type DraftBrew = z.infer<typeof draftBrewSchema>
