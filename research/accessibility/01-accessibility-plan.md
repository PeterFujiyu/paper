...
Status: **implemented — every phase landed.** Reconciled against the code 2026-08-26.
Date: 2026-07-06 (plan) · shipped the same day in `a83a54c`
...
`a83a54c` (*feat(a11y): add live regions, landmarks, and keyboard affordances*) landed this plan in
full. Phase by phase, checked against the working tree rather than against the commit message:
